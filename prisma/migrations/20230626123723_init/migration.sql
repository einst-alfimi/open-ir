...
INSERT INTO "new_Score" ("assist", "authorId", "clear", "content", "deviceType", "ebd", "egd", "egr", "ems", "epg", "epr", "gauge", "ghost", "id", "judgeAlgorithm", "lbd", "lgd", "lgr", "lms", "lntype", "lpg", "lpr", "maxcombo", "minbp", "notes", "option", "orajaVersionId", "passnotes", "rule", "scoreType", "songId", "type", "valid") SELECT "assist", "authorId", "clear", "content", "deviceType", "ebd", "egd", "egr", "ems", "epg", "epr", "gauge", "ghost", "id", "judgeAlgorithm", "lbd", "lgd", "lgr", "lms", "lntype", "lpg", "lpr", "maxcombo", "minbp", "notes", "option", "orajaVersionId", "passnotes", "rule", "scoreType", "songId", "type", "valid" FROM "Score";
DROP TABLE "Score";
